...
class TestS3BucketConnectorMethods(unittest.TestCase): # inheriting from TestCase
    """
    Testing the S3 Bucket Connnector class
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket = self.s3.Bucket(self.s3_bucket_name) # bucket instance
    ...
    def test_list_files_in_prefix_ok(self):
        """
        Tests the test_list_files_in_prefix_ok method for getting 2 file keys
